...
### Path Finetuning
I experiment with a method with training first on individual random samples (the 'ends' of the random walks) then finetuning on entire random walks. I empirically show this typically improves loss and accuracy metrics, even where normal training with more data failed to produce or produced lesser improvements. I refer to this method as "Path Finetuning."
