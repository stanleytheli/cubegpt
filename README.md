...
For these results, the model CubeGPT-2g-PFT was used. Setting the beam width *w* = 4000, the model is able to highly consistently solve fully scrambled Rubik's Cubes. And with only *w* = 300, it was able to achieve a fully optimal depth-10 solver.
